package com.sunyard.job.service.impl;

import com.sunyard.common.annotation.CronTag;
import com.sunyard.common.service.impl.BaseService;
import com.sunyard.job.dao.JobMapper;
import com.sunyard.job.domain.Job;
import com.sunyard.job.service.JobService;
import com.sunyard.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("cc.com.sunyard.job.task");
