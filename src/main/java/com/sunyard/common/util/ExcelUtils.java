package com.sunyard.common.util;

import com.sunyard.common.annotation.ExportConfig;
import com.sunyard.common.handler.ExportHandler;
import com.sunyard.common.util.poi.convert.ExportConvert;
import com.sunyard.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用cc.com.sunyard.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用cc.com.sunyard.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
